...
# atom in parameter 1, version in parameter 2, np in parameter 3
#
set atom=$1
set version=$2
set np=$3
...
if ($np == "") then
  echo -n "Give number of processors: "
  set np=($<)
else
  echo "number of procesors is: $np"
endif
...
time mpirun -np $np mul$version"_3d.x"
